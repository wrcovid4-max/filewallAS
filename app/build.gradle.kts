...
android {
    namespace = "com.filewall"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.filewall"
        // API 26 keeps AndroidKeyStore AES/CTR + HMAC and adaptive icons available.
        // The primary test device (Android 11) is API 30.
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
